...
This is AgentProbe's headline feature. It answers *"how accurate is your
...
from agentprobe.evaluator.judge import judge_run
from agentprobe.models import GoldenCase
from agentprobe.regression.stats import bootstrap_ci
