"""SQLAlchemy 2.0 ORM models for AgentProbe persistence.

These are the on-disk representations of the in-memory dataclasses in
``agentprobe/models.py``. The mapping is intentionally lossy in one direction:
...
class ReviewQueueItem(Base):
    ...
    Created when :func:`agentprobe.evaluator.should_flag_for_review` fires for a
